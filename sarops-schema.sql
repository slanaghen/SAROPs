...
CREATE POLICY "Allow all authenticated to start an incident" ON incidents
...
CREATE POLICY "Admins/Staff can manage all operational periods" ON operational_periods
  FOR ALL TO authenticated USING (check_is_operational_staff()) WITH CHECK (check_is_operational_staff());
CREATE POLICY "Allow all authenticated to create operational periods" ON operational_periods
  FOR INSERT TO authenticated WITH CHECK (TRUE);
...
BEGIN
    ...
    EXECUTE 'CREATE POLICY "Admins can manage all incidents" ON incidents
      FOR ALL TO authenticated USING (check_is_operational_staff()) WITH CHECK (check_is_operational_staff());';
    EXECUTE 'CREATE POLICY "Allow all authenticated to start an incident" ON incidents
      FOR INSERT TO authenticated WITH CHECK (TRUE);';
    ...
    EXECUTE 'CREATE POLICY "Admins/Staff can manage all operational periods" ON operational_periods
      FOR ALL TO authenticated USING (check_is_operational_staff()) WITH CHECK (check_is_operational_staff());';
    EXECUTE 'CREATE POLICY "Allow all authenticated to create operational periods" ON operational_periods
      FOR INSERT TO authenticated WITH CHECK (TRUE);';
