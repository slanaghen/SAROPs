 ...
 */
export let OPERATIONS_REFRESH_INTERVAL = 30000; // 30 seconds
 ...
 */
export let RESPONDER_REFRESH_INTERVAL = 30000; // 30 seconds
 ...
 */
export let SARTOPO_REFRESH_INTERVAL = 30000; // 30 seconds
